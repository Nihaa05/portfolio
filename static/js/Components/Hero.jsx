...
const Hero = () => {
  ...
  const texts = ['Data Engineer', 'Analytics Engineer', 'Workflow Automation Specialist'];
        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={7} sx={{ textAlign: 'left' }}>
            ...
            >
              ...
              >
                I engineer robust data pipelines and automate complex business workflows, turning raw information into scalable assets. With deep expertise in the Microsoft 365 ecosystem and cloud architecture, I build solutions that drive operational efficiency and strategic clarity.
              </Typography>
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-start' }}>
                <motion.a
                  href="https://www.linkedin.com/in/niharika-pendem/"
                  target="_blank"
                ...
                <motion.a
                  href="mailto:niharikapendem99@gmail.com"
                  whileHover={{ y: -3 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <Box
