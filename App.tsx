  ...
  if (isLoading) {
    return (
      <div className="portfolio7-wrapper" data-theme="dark">
        ...
        >
          <MinimalSpinner />
          <TypingText text="Behind every insight is a well-built pipeline.\nAutomation turns complexity into clarity." glow />
        </div>
      </div>
    )
  }
...
export default UjwalaPortfolio
